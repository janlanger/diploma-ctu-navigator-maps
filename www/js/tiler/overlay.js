...
function Overlay(src, x, y) {
  ...
  el.style.position = 'absolute';
    ...
    el.style.setProperty("-webkit-transform-origin", "0 0", "")
    el.style.setProperty("-moz-transform-origin", "0 0", "")
    el.style.setProperty("-ie-transform-origin", "0 0", "")
...
Overlay.prototype.draw_ = function() {
    if(this.get('topLeft') != null) {
        matrixDef = this.computeTransform_();
        this.el_.style.setProperty("transform", matrixDef,"");
        this.el_.style.setProperty("-webkit-transform", matrixDef, "");
        this.el_.style.setProperty("-moz-transform", matrixDef, "");
        this.el_.style.setProperty("-ie-transform", matrixDef, "");
